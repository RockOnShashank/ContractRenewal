...
public class ViewRequestLSAdapter extends RecyclerView.Adapter<ViewRequestLSAdapter.ViewHolder> {
    ...
    ViewRequestLSAdapter(Context context, ArrayList<ServiceRequest> list) {
    ...
    @Override
    public ViewRequestLSAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_view_request_ls, parent, false);
        return new ViewRequestLSAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(ViewRequestLSAdapter.ViewHolder holder, int position) {
