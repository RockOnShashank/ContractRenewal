...
public class FeedbackFragment extends Fragment implements ResponseCallback {

   private View view;
   private TextView fragmentTitle;
    private TextView tv_category,tv_status,tv_id,tv_subCategory,tv_request_status,tv_date,tv_preferred_dateandtime,tv_description,tv_follow_up,tv_cancel, tv_reschedule;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((HomeActivity) getActivity()).toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               loadFragmentafterCancel(new HistoryFragment());
        ...
        if (newViewRequest.get(position).getCompletionDate()!=null) {
            try {
                date = getMonth(newViewRequest.get(position).getCompletionDate());
            } catch (ParseException e) {
                e.printStackTrace();
            }
        ...
        if (newViewRequest.get(position).getStatus().equalsIgnoreCase("Canceled")){
            ...
            tv_request_status.setTextColor(getActivity().getResources().getColor(R.color.red));

        }
        if (newViewRequest.get(position).getStatus().equalsIgnoreCase("Closed")){
            tv_status.setText("Closed On");
            tv_request_status.setTextColor(getActivity().getResources().getColor(R.color.light_text_color));
        ...
        new RequestService(getActivity(), FeedbackFragment.this).setArgumentsAttachment("ServiceRequest/Attachments/" + newViewRequest.get(position).getWOCode());
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadFragments(new ReopenServiceFragment(), bundle);
