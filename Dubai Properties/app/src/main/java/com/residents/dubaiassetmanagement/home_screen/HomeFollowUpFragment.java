...
public class HomeFollowUpFragment extends Fragment implements ResponseCallback {
    ...
    FollowUpFragment.FollowedUp followedUp;
...
//Set Fragment Title
            ...
            public void onClick(View view) {
                if (et_comments.getText().toString().isEmpty()){
                    ...
                    try {
                        ...
                        jsonObject.put("SITEID", bundle.getString("maximo_site"));
                    ...
                    new RequestService(getActivity(), HomeFollowUpFragment.this).postRequest("ServiceRequest/CreateFollowUp", jsonObject);
 ...
 /*   try {
    ...
    public void onAttach(Context context) {
        ...
        followedUp = (FollowUpFragment.FollowedUp) context;
    }
