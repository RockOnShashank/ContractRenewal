...
public class ScheduleFragmentHome extends Fragment implements View.OnClickListener, ResponseCallback {
...
//Set Fragment Title
        ...
        if (bundle.containsKey("siteid")){
            maximoSiteID = bundle.getString("siteid");
...
*/
                        ...
                        try {
                            ...
                            if (bundle.containsKey("siteid")) {
                                jsonObject.put("SITEID", maximoSiteID);
...
"SCHED_SLOT":"10:00 am - 12:00 pm"} */
                      ...
                      /*  DESCRIPTION: "The appointment is required" 
                        ...
                        new RequestService(getActivity(), ScheduleFragmentHome.this).postRequest("Yardi/CreateUpdateScheduleRequest", jsonObject);
                    } else {
                        ...
                        new RequestService(getActivity(), ScheduleFragmentHome.this).postRequest("Yardi/CreateServiceRequest", jsonObjectPArent);
                    }
                }
                break;
        }
