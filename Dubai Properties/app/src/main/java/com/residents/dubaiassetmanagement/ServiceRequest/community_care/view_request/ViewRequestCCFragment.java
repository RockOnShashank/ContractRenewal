...
public class ViewRequestCCFragment extends Fragment implements  View.OnClickListener, ResponseCallback,ViewRequestCCAdapter.ItemClickListener{
    ...
    private ViewRequestCCAdapter viewRequestAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentTitle.setText("COMMUNITY CARE");
        ...
        tv_view_history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadFragment(new HistoryCCFragment(),bundle);
            }
        });
        ...
        gson = new Gson();
        if (!appSharedPrefs.getString("CC_List", "").equalsIgnoreCase("")) {

            String json = appSharedPrefs.getString("CC_List", "");
            Type type = new TypeToken<List<ServiceRequest>>(){}.getType();
            viewRequests = gson.fromJson(json, type);



            viewRequestAdapter = new ViewRequestCCAdapter(getActivity(), viewRequests);
            viewRequestAdapter.setClickListener(this);
            rv_maintenance_request.setAdapter(viewRequestAdapter);


        }else {
            new RequestService(getActivity(), ViewRequestCCFragment.this).setArguments("Yardi/FetchServiceRequest?tCode=" + mSavePreference.getString(IpreferenceKey.TCODE) + "&serviceRequestPageType=" + "1" + "&serviceRequestType=" + "2");
        }
        return view;
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ViewRequestFragment.OnFragmentInteractionListener) {
            mListener = (ViewRequestFragment.OnFragmentInteractionListener) context;
        } else {
    ...
    public void onSuccess(String response) {
        ...
        if (serviceResponse.equalsIgnoreCase("")) {
           ...
           // Toast.makeText(getActivity(),"Server Error",Toast.LENGTH_LONG).show();
            ...
            prefsEditor.putString("CC_List", json);
            prefsEditor.commit();
    ...
    public void onItemClick(View view, int position) {
        ...
        loadFragment(new ViewDetailCCFragment(), bundle);
    }
